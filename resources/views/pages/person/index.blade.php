...
@section('content')
   <div class="row mt-5 mb-5">
      ...
      @can('create person')
      <div class="col">
         <a href="{{url('person/create')}}"><button type="button" class="btn btn-primary">
            Create
         </button></a>
      </div>
      @endcan
   ...
   <script>
      $( document ).ready(function() {
         ...
         var dtOrg = $('#table-person').DataTable({
            //scrollX: true,
            bFilter: true,
            serverSide: true,
            processing: true,
            ...
            columns: [
                ...
                { 
                  render: function (data, type, full) {
                        var img = '';
                        if(full.avatarPath != null && full.avatarPath != '')
                           img += '<img src="'+full.avatarPath+'" id="logo" width="70">';
